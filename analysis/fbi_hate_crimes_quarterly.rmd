...
# Desegregate trends for anti-Muslim and anti-Latino Hate Crimes
...
# The Effect Trumps Election on Anti-Muslim and Anti-Hispanic Hate Crimes
...
calc_perc_change <- function(data, n){
  ...
  cat ( paste("The increase in Hate Crimes", as.character(3*n+3), "before and after Trumps election is",  round(after_mean/before_mean*100-100, 2), "percent.\n" ) )
  # return(dt_sliced)
}
