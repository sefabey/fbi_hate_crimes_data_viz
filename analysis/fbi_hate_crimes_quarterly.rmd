...
qt_hate_muslim %>% 
  ...
  labs(title = "Quarterly Aggregated Anti-Muslim Hate Crime Incidents in the US, 1991-2018",
...
qt_hate_muslim %>% 
  ...
  scale_x_date(breaks = seq.Date(dmy("01-01-1991"), dmy("31-12-2018"), by= "2 year"), 
               ...
               expand=c(0,0))+
  hrbrthemes::theme_ipsum_rc()+
  labs(title = "Detrended Quarterly Anti-Muslim Hate Crime in the US, 1991-2018",
...
## Percentage change for anti-Muslim Hate Crimes
